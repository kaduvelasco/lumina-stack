...
<body class="bg-slate-900 text-slate-200 font-sans min-h-screen flex flex-col items-center justify-center p-6">
    ...
    <div class="max-w-4xl w-full">
        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
            ...
            <div class="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                <i class="fa-solid fa-terminal text-blue-400 mb-2 text-lg"></i>
                <p class="text-xs text-slate-500 uppercase mb-1">Gerenciar Stack</p>
                <p class="font-mono text-sm">lumina</p>
            </div>
            <div class="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                <i class="fa-solid fa-floppy-disk text-purple-400 mb-2 text-lg"></i>
                <p class="text-xs text-slate-500 uppercase mb-1">Gerenciar Banco</p>
                <p class="font-mono text-sm">lumina-db</p>
            </div>
        </div>
